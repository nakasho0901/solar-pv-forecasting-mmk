...
def get_model(model_name, exp_conf):
    """
    configの model_name に応じてモデルを生成する。
    既存の分岐はそのまま、RevIN版MMKを追加しただけ。
    """
    ...
    # ★追加：RevIN版（BN/Dropout/ResidualはMMK_Mixと同じ構造で、RevINだけ前後に挟む）
    ...
    # configに余計なキーがあっても __init__ に渡らないようにフィルタ
